...
_G.packer_plugins = {
  ["ayu-vim"] = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/ayu-vim"
  },
  ["completion-nvim"] = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/completion-nvim"
  },
  ["elm-vim"] = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/elm-vim"
  },
  fzf = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/fzf"
  },
  ["fzf.vim"] = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/fzf.vim"
  },
  gruvbox = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/gruvbox"
  },
  ["markdown-preview.nvim"] = {
    commands = { "MarkdownPreview" },
    loaded = false,
    needs_bufread = false,
    path = "/home/steen/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim"
  },
  ["nim.nvim"] = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/nim.nvim"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/nvim-lspinstall"
  },
  ["nvim-treesitter"] = {
    loaded = true,
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/presence.nvim"
  },
  rainbow = {
    loaded = true,
    path = "/home/steen/.local/share/nvim/site/pack/packer/start/rainbow"
  },
  ["telescope.nvim"] = {
    loaded = true,
